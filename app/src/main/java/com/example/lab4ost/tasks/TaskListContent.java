package com.example.lab4ost.tasks;
...
public class TaskListContent {
    ...
    private static Task createDummyItem(int position) {
        return new Task(String.valueOf(position), "Jacob " , "Xyz", "06/02/2000", "661032456", "1");
    }
    ...
    public static class Task implements Parcelable {
        ...
        public Task(String id, String name, String surname, String birthday, String number, String picture) {
            this.id = id;
            this.name = name;
